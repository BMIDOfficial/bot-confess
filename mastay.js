...
client.on('authenticated', () => {
    // client.setStatus("*STATUS : Online* | _*BOT CONFESS CREATED BY MASTAY*_")
    console.log("AUTHENTICATED")
})

client.on('disconnected', () => {
    // client.setStatus("*STATUS : Offline* | _*BOT CONFESS CREATED BY MASTAY*_")
